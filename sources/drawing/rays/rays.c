...
/*   Updated: 2025/05/11 15:53:37 by inikulin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cast_rays(t_mlx *mlx)
{
	...
	{
		calc_ray(&arg);
		if (mlx->map.minimap_show && i % MINIMAP_SHOW_EACH_TH_RAY == 0)
...
{
	arg->cast.bigmap_left_top = ft_point_make(mlx->map.map_width
			* MINIMAP_BLOCK_SIZE, 0);
