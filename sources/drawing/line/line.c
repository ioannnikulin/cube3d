...
/*   Updated: 2025/04/10 15:50:24 by inikulin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	loop_steep(t_line_arg *arg)
{
	...
	while (x < arg->end1x)
	{
		...
		pixel(arg->mlx, flr(arg->intery) + 1, x, color(clr, fpart(arg->intery)));
...
static t_line_arg	make_la(t_point *f, t_point *t, t_mlx *s)
{
	t_line_arg	arg;
